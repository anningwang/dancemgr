...
function danceCreateSchoolDatagrid(datagridId, url) {
    ...
    $(dg).datagrid({
        ...
        columns: [[
            ...
            {field: 'address', title: '分校地址', width: 400, align: 'center'},
            {field: 'manager', title: '负责人姓名', width: 70, align: 'center'},
            {field: 'manager_phone', title: '负责人手机', width: 120, align: 'center'},
            {field: 'tel', title: '分校联系电话', width: 120, align: 'center'},
            {field: 'zipcode', title: '邮政编码', width: 70, align: 'center'},
