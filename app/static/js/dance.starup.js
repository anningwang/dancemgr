...
$(function() {
    $('#treeStudent').tree({    // 学员管理
        ...
        onClick:  function (node) {
            ...
            if(node.text in entrance){
                entrance[node.text].fn(options_root);
            }else if ('module' in node.attributes && node.attributes['module'] in entrance) {
                entrance[node.attributes['module']].fn(options_root);
