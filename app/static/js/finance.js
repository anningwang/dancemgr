...
function addEditExpense(condition, uid, options) {
    ...
    if (uid <=0) {
        dcOpenDialogNewExpense('dlg-id-new-house_rent', title, 0, 'icon-save', options);
    }else {
        dcOpenDialogNewExpense('dlg-id-chg-house_rent', title, uid, 'icon-save', options);
    }
}
...
function addEditHouseRent(condition, uid, options) {
    ...
    options.condition = condition;
    if (uid <=0) {
        dcOpenDialogNewHouseRent('dlg-id-new-expense', title, 0, 'icon-save', options);
    }else {
        dcOpenDialogNewHouseRent('dlg-id-chg-expense', title, uid, 'icon-save', options);
    }
}
